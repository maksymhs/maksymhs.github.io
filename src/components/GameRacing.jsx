...
function RotatingSign() {
  ...
  const sub = lang === 'es' ? 'Neon Racer - Próximamente' : lang === 'ru' ? 'Неоновая Гонка - Скоро' : 'Neon Racer - Coming Soon'

  return (
    <group ref={ref}>
      <Text position={[0, 0.6, 0]} fontSize={0.5} color="#ff00ff" anchorX="center" anchorY="middle" font={FONT}>
        {title}
      </Text>
      <Text position={[0, -0.2, 0]} fontSize={0.2} color="#ff80ff" anchorX="center" anchorY="middle" font={FONT}>
        {sub}
      </Text>
      {/* Construction bars */}
    ...
    <div style={{ width: '100vw', height: '100vh', background: '#1a1a2e', position: 'relative' }}>
      ...
      <a
        ...
        style={{
          ...
          border: '2px solid rgba(255,0,255,0.5)', borderRadius: '6px',

...
const LOCAL_COMMANDS = [
  { action: 'dance',     keywords: { en: ['dance','dancing','let\'s dance','move','groove','headphones','dj','party'], es: ['bailar','baila','bailemos','música','auriculares','fiesta','baile','mueve'], ru: ['танцевать','танцуй','потанцуем','музыка','наушники','вечеринка','танец'] }, response: { en: 'Let\'s dance! 🎶', es: '¡A bailar! 🎶', ru: 'Давай танцевать! 🎶' } },
  { action: 'sleep',     keywords: { en: ['sleep','sleeping','go to sleep','bed','rest','nap','tired','lie down','goodnight'], es: ['dormir','duerme','duermete','cama','descansar','siesta','cansado','acuéstate','buenas noches','a dormir','echarse'], ru: ['спать','спи','ложись','кровать','отдых','сон','устал','спокойной ночи'] }, response: { en: 'Time to rest... 😴', es: 'Hora de descansar... 😴', ru: 'Пора отдыхать... 😴' } },
  { action: 'sofa',      keywords: { en: ['sofa','couch','sit down','relax','chill','sit on sofa','lay down'], es: ['sofá','sofa','sentar','siéntate','relajar','descanso','relájate','tumbarse'], ru: ['диван','сесть','отдохнуть','расслабиться','посиди'] }, response: { en: 'Let\'s chill on the sofa! �️', es: '¡Vamos al sofá! �️', ru: 'Пойдём на диван! �️' } },
  { action: 'walk',      keywords: { en: ['street','walk','go out','door','let\'s go','take a walk','stroll','go for a walk'], es: ['calle','pasear','salir','puerta','caminar','fuera','vamos','sal','paseo','anda','vámonos'], ru: ['улица','гулять','выйти','дверь','прогулка','пойдём','выходи'] }, response: { en: 'Let\'s go for a walk! �', es: '¡Vamos a dar un paseo! �', ru: 'Пойдём на прогулку! �' } },
  { action: 'outdoor',   keywords: { en: ['garden','outdoor','window','cat','michi','outside','yard','patio'], es: ['jardín','exterior','ventana','gato','michi','patio','afuera'], ru: ['сад','окно','кот','мичи','двор','снаружи'] }, response: { en: 'Let\'s go outside! �', es: '¡Vamos afuera! �', ru: 'Пойдём на улицу! �' } },
  { action: 'bookshelf', keywords: { en: ['bookshelf','books','skills','shelf','library','read','knowledge','what do you know','what can you do','tech','technologies','tell me about you','about yourself','know','stack','what you know','your skills'], es: ['estantería','libros','skills','leer','biblioteca','estante','conocimiento','qué sabes','qué puedes','tecnologías','cuéntame','háblame de ti','sabes','conoces','stack','habilidades','competencias'], ru: ['полка','книги','навыки','библиотека','читать','знания','что умеешь','что знаешь','технологии','расскажи о себе','стек','умения'] }, response: { en: 'Let me show you my skills! �', es: '¡Te enseño mis conocimientos! �', ru: 'Покажу тебе мои навыки! �' } },
  { action: 'chest',     keywords: { en: ['chest','experience','work','career','treasure','job','resume','cv','worked','companies','where did you work','employment','history'], es: ['cofre','experiencia','trabajo','carrera','tesoro','empleo','currículum','cv','empresas','dónde has trabajado','trabajado','historial','trayectoria'], ru: ['сундук','опыт','работа','карьера','клад','резюме','компании','где работал','трудовой'] }, response: { en: 'Let me show you my experience! �', es: '¡Te enseño mi experiencia! �', ru: 'Покажу тебе мой опыт! �' } },
  ...
  { action: 'github',    keywords: { en: ['github','code','projects','repository','repo','source code'], es: ['github','código','proyectos','repositorio','código fuente'], ru: ['github','код','проекты','репозиторий','исходный код'] }, response: { en: 'Check out my code! 💻', es: '¡Mira mi código! 💻', ru: 'Смотри мой код! 💻' } },
  ...
  { action: 'clock',     keywords: { en: ['meeting','schedule','calendar','book a meeting','call','appointment','agenda','availability','free time','slot'], es: ['reunión','agendar','calendario','cita','llamada','disponibilidad','hueco','agenda','quedar'], ru: ['встреча','назначить','календарь','звонок','запись','расписание','свободен'] }, response: { en: 'Let\'s schedule a meeting! 📅', es: '¡Agendemos una reunión! 📅', ru: 'Назначим встречу! 📅' } },
  { action: 'default',   keywords: { en: ['back','return','home','room','go back','reset'], es: ['volver','regresar','casa','habitación','atrás','vuelve'], ru: ['назад','вернуться','домой','комната','обратно'] }, response: { en: 'Back to the room! 🏠', es: '¡De vuelta a la habitación! 🏠', ru: 'Назад в комнату! 🏠' } },
]
